#!/usr/bin/env python3
# importing from flask modules need to run script.  Flask, render_remplate, and request
...
def ciscoios():
    try:
        qparms = {}
        # user passes switchname= or default "bootstrapped switch" first option is requested key, seconds is default entry
        ...
        return render_template("baseIOS.conf.j2", **qparms)  # ** unpacks a dictionary
